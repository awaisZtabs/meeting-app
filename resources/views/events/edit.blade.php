           ...
           @csrf
            <div class="mb-6">
                ...
                <input type="text" id="event_subject" name="event_subject"
                    ...
                    placeholder="Subject" required value={{ $event->subject }}>
            ...
            <div class="mb-6">
                ...
                <input type="email" id="first_attendee_email" name="first_attendee_email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="attende@email.com" required value={{ $event->first_attendee_email }}>
                      <span class="error-message"></span>
            </div>
            <div class="mb-6">
                ...
                <input type="email" id="second_attendee_email" name="second_attendee_email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="attende@email.com" required value={{ $event->second_attendee_email }}>
                      <span class="error-message"></span>
            </div>
            <div class="mb-6">
                ...
                <input type="datetime-local"  data-enabletime=true id="event_date" name="event_date"
                    ...
                    placeholder="Event Date" required defaultDate={{ $event->event_date }}>
                      <span class="error-message"></span>
            </div>
              <span class="error-message"></span>
 ...
 flatpickr("input[type=datetime-local]",config);
   ...
   $(document).ready(function() {
       $('#create-event').click(function() {
            ...
            $('.error-message').text("");
              $.ajax({
              url: "{{ route('events.update', $event->id) }}", // Replace with your actual route URL
              type: 'PATCH', // or 'GET' depending on your route definition
              data: formData,
